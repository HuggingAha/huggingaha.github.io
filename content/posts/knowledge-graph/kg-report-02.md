...
series_order: 2
showAuthor: false
aliases: ["/blogs/kg/knowledge-grap-development-report/knowledge-representation-learning/"]
---
...
大量知识具有时效性，随着时间发展在动态变化。例如，美国总统在2010年是奥巴马，在2020年是特朗普。利用时序分析和图神经网络等技术，对于分析图谱结构随时间的变化规律和趋势，以及知识推理都具有重要意义。
...
<figure>
  ...
  <figcaption style="text-align: center;">图1 含文本描述的知识图谱例子（左），KEPLER 框架（右）</figcaption>
</figure>
...
<figure>
  ...
  <figcaption style="text-align: center;">图2 单步与多步关系信息示例</figcaption>
</figure>
...
<figure>
  ...
  <figcaption style="text-align: center;">图3 融合结构化知识到预训练语言模型的三种途径</figcaption>
</figure>
