...
date: 2022-07-22
description: "解析 GATNE 如何用基向量、关系向量和自注意力统一建模属性化多重异构网络，并通过 GATNE-I 应对新节点冷启动。"
categories: ["notes"]
topics: ["knowledge-graph"]
tags: ["knowledge-graph", "gnn"]
showAuthor: false
aliases: ["/blogs/kg/gatne-representation-learning-for-attributed-multiplex-heterogeneous-network/"]
---
