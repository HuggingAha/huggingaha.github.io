---
title: "GIB 与 AD-GCL 如何打造更鲁棒的 GNN"
date: 2022-10-09
description: "从图信息瓶颈出发，解析 GIB 与 AD-GCL 如何过滤无关信息、学习鲁棒表示，并说明距离编码的作用。"
categories: ["notes"]
topics: ["knowledge-graph"]
tags: ["gnn"]
showAuthor: false
aliases: ["/blogs/kg/modular-manifolds-thinking-machines/"]
---
...
- `max I(Y; Z)`（最大化与`Y`的互信息）：保留与任务相关的信息，确保表示的**预测能力** 。
