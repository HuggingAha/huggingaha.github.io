...
date: 2025-11-01T09:10:00+08:00
description: "解析 Agent Skills 的三层加载与目录规范，厘清其与 MCP、Function Calling 的分工。"
categories: ["notes"]
topics: ["agent"]
tags: ["agent", "agent-skills", "claude"]
series: ["agent-skills"]
series_order: 3
showAuthor: false
aliases: ["/blogs/agent/claude-skills/"]
---
