...
date: 2025-12-31
description: "从信息论解释 Agent 的压缩器—预测器架构，学会用互信息和 Scaling Law 优化模型规模与算力分配。"
categories: ["notes"]
topics: ["agent"]
tags: ["agent", "information-theory"]
showAuthor: false
aliases: ["/blogs/agent/information-theoretic-perspective-on-agentic-system-design/"]
---
