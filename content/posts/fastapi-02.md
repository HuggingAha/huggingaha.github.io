...
date: 2025-04-27T09:10:00+08:00
description: "使用 Annotated 和 Pydantic V2 校验 API 参数与请求体，借模型继承划清数据边界并减少重复定义。"
categories: ["notes"]
topics: ["engineering"]
tags: ["python", "fastapi"]
series: ["fastapi"]
series_order: 2
showAuthor: false
aliases: ["/blogs/python/fastapi/fastapi-02/"]
---
...
### 4.4 在路由中的应用
```python
def fake_save_user(user_in: UserCreate) -> dict:
    return {**user_in.model_dump(), "id": 1, "is_active": True}
