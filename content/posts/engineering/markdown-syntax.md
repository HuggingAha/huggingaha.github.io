...
title: "Markdown 语法"
date: 2022-06-27
description: "汇总 Markdown 的标题、列表、链接、代码、表格等基础与扩展语法，帮助你在纯文本中快速写出结构清晰的技术文档。"
categories: ["cheatsheets"]
topics: ["engineering"]
tags: ["markdown"]
showAuthor: false
aliases: ["/blogs/sundry/markdown-grammar/"]
---
...
通过创建带有数字符号（`#`）和自定义标题ID的[标准链接](https://markdown.com.cn/basic-syntax/links.html)，可以链接到文件中具有自定义ID的标题。
