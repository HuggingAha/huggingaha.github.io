---
title: "“思考”工具：使 Claude 在复杂的工具使用情况下能够停止并思考"
date: 2025-03-22T09:00:00+08:00
description: "Anthropic 官方博客译文：借助“思考”工具，让 Claude 在复杂工具调用场景中停下来逐步推理"
...
series_order: 3
showAuthor: false
aliases: ["/blogs/agent/claude-think-tool-translate/"]
---
...
{{< alert "claude" >}}
[阅读原文：The think tool（Anthropic）](https://www.anthropic.com/engineering/claude-think-tool)
{{< /alert >}}
...
这使得“思考”工具更适用于 Claude 仅凭用户查询无法获得形成回应所需的全部信息，并且需要处理外部信息（例如，工具调用结果中的信息）的场景。Claude 使用“思考”工具进行的推理，其全面性不如“扩展思考”，它更侧重于模型发现的新信息。
