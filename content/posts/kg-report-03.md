...
series_order: 3
showAuthor: false
aliases: ["/blogs/kg/knowledge-grap-development-report/entity-extraction/"]
---
...
实体抽取的核心研究对象是如何从文本中识别指定类别的实体，通常包含**实体边界识别**（判断一个字符串是否构成完整实体）和**实体分类**（将识别出的实体划分到指定类别）两个子任务。在部分特定数据集和任务设定下，人名、地名、机构名等常见实体类别的中英文实体抽取 F1 值已能达到 90% 以上。
