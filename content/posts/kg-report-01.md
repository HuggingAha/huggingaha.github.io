...
date: 2022-09-13
description: "梳理知识表示的本体、规则与事件三类知识，说明 RDF、OWL 等建模语言和工具，帮助搭建可推理的知识图谱模式层。"
categories: ["notes"]
...
series_order: 1
showAuthor: false
aliases: ["/blogs/kg/knowledge-grap-development-report/knowledge-representation-and-modeling/"]
---
...
事件知识描述"谁在什么时间、什么地点、对什么对象做了什么"，相比本体和规则知识，它包含动作、时间、地点、参与者等多个要素，维度更高、结构更复杂，通常用事件框架（event schema）来建模。事件知识的抽取与建模是知识图谱中的重要分支，本系列的第 5 篇有专门讨论，参见[知识图谱发展报告（2022）-事件知识抽取](/posts/kg-report-05/)。
...
- *Rule Markup Language (RuleML)* 是一系列一系列 Web 文档和数据语言的统一系统，通过模式语言进行句法指定，最初为 XML 开发并转换为其他格式，如 JSON。
